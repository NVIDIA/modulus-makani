...
class GeometricL1(torch.nn.Module):
    def __init__(self, grid_type, img_shape, crop_shape=None, crop_offset=(0, 0), normalize=False, channel_reduction="mean", batch_reduction="mean"):
        super(GeometricL1, self).__init__()

        self.quadrature = GridQuadrature(grid_type, img_shape=img_shape, crop_shape=crop_shape, crop_offset=crop_offset, normalize=normalize)
...
class GeometricACC(torch.nn.Module):
    def __init__(self, grid_type, img_shape, crop_shape=None, crop_offset=(0, 0), normalize=False, channel_reduction="mean", batch_reduction="mean", eps=1e-8):
