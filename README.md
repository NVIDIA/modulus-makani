...
:warning: **architectures with complex-valued weights**: Training some architectures with complex-valued requires yet to be released patches to PyTorch. These will currently fail - a patch will follow soon.
